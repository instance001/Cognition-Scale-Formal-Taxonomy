...
| --- | --- | --- | --- | --- | --- | --- | --- |
| LCM — Large Cognition Model | LCM, humans | ~ | ∅ | Baseline class (biological cognition) | Human-grade multimodal, emotionally grounded, adaptive cognition; gold standard reference baseline | Not an AI model class; not substrate-agnostic within artificial systems | Cognition-Scale-Formal-Taxonomy/cognition-scale.md |
...
| MCM — Modest Cognition Model | MCM, Janet class | ~ | ∅ | Proposed artificial cognition class | Deterministic, modular, schema-gated systems with explicit skill trees, inspected memory records, and conservative refusal behavior | Not probabilistic generative LLMs; not emergent large models; not a guarantee of correctness by label alone | Cognition-Scale-Formal-Taxonomy/README.md |
...
| Cognition Scale | cognition taxonomy | ~ | ∅ | Taxonomic framework | Four-tier taxonomy classifying human and artificial cognition systems by structural/behavioral criteria (LCM, LLM, MCM, SCM) | Not a capability benchmark or anthropomorphic ranking | Cognition-Scale-Formal-Taxonomy/README.md; cognition-scale.md |
